<template>
	<div class="h-fit w-fit max-w-lg rounded-xl bg-white p-4 drop-shadow-lg">
		<h4 class="text-xl font-medium text-neutral-800 pb-4">Head Quarter</h4>

		<!-- grid  -->
		<div class="grid grid-cols-1 grid-rows-2 md:gap-4 gap-2">

			<!-- flex container -->
			<div class="flex justify-between flex-col md:flex-row space-y-3 md:space-y-0">
				<!-- item 1 -->
				...
				<div class="flex items-center w-1/2">
					<svg
						...
						class="fill-primary"
					>
						<path d="M2 20V4h20v16H2Zm10-7l8-5V6l-8 5l-8-5v2l8 5Z" />
					</svg>
					<p class="ml-2">hello@ipsum.com</p>
				</div>
			</div>
			...
			<div class="col-span-2 flex items-center">
				...
				<p class="ml-2">Lorem ipsum dolor sit amet. Lorem, ipsum dolor.</p>
			</div>
		</div>
	</div>
</template>
